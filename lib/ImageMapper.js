...
ImageMapper.propTypes = {
	...
	fillColor: _propTypes.string,
	height: _propTypes.number,
	lineWidth: _propTypes.number,
	map: _propTypes.shape({
		areas: _propTypes.arrayOf(_propTypes.shape({
			area: _propTypes.shape({
				coords: _propTypes.arrayOf(_propTypes.number),
